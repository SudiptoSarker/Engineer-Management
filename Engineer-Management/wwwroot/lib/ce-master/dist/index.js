    ...
    var jexcel = (function(el, options) {
        ...
        var defaults = {
            ...
            text:{
                ...
                insertANewRowAfter: '現在の行の下に１行追加',



                insertANewRowAfter1: '要員に新規の役割を追加',
        ...
        */
         ...
         * @return void
         */
        obj.insertRow1 = function (mixed, rowNumber, insertBefore) {
            // Configuration
            if (obj.options.allowInsertRow1 == true) {
                // Records
                var records = [];
                ...
                for (var row = rowIndex; row < (numOfRows + rowIndex); row++) {
                    ...
                    for (var col = 0; col < obj.options.columns.length; col++) {
                        ...
                        obj.options.data[row][0] = 4444;
                        obj.options.data[row][0] = obj.getValue("A2");
        ...
        if (options && options.contextMenu != null) {
            ...
            obj.options.contextMenu = function(el, x, y, e) {
                ...
                if (y == null) {
                    ...
                    if (obj.options.allowInsertRow1 == true) {
                        items.push({
                            title: obj.options.text.insertANewRowBefore1,
                            onclick: function () {
                                obj.insertRow1(1, parseInt(y), 1);
                            }
                        });

                        items.push({
                            title: obj.options.text.insertANewRowAfter1,
                            onclick: function () {
                                obj.insertRow1(1, parseInt(y));
                            }
                        });
                    }
