...
// Changed by Shimizu                insertANewRowAfter: 'Insert a new row after',

// Added by Shimizu ---------------------------------------------------------------------------------------
                insertANewRowAfter: '要員を追加する',
                insertANewRowMemberAfter: '同じ要員を複製する',
                copy: 'コピー',
                paste: '貼り付け',
                saveAs: 'CSVで保存',
                about: 'このアプリについて',
                deleteSelectedRows: '選択した要員を削除',

// Added by Shimizu ---------------------------------------------------------------------------------------
//  Changed by Shimizu                deleteSelectedRows: 'Delete selected rows',
                editComments: 'Edit comments',
                addComments: 'Add comments',
                comments: 'Comments',
                clearComments: 'Clear comments',
//  Changed by Shimizu               copy: 'Copy...',
//  Changed by Shimizu               paste: 'Paste...',
//  Changed by Shimizu                saveAs: 'Save as...',
//  Changed by Shimizu                about: 'About',
...
// Added by Shimizu --------------------------------------------------------------------------------------------
                    ...
                    if (obj.options.allowInsertRowOfMember == true) {
                        items.push({
                            ...
                            onclick: function () {
//                                obj.insertRowOfMember(0, parseInt(y));

                                obj.insertRowOfMember(0, obj.getColumnData(parseInt(0))[y], parseInt(y));  //0 of parseInt(0) should be changed. 0 means 1 column data.
                            }
                        });
                    }
